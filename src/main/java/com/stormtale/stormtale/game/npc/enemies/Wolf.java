...
public class Wolf extends AbstractNPC implements Serializable {
    ...
    public Wolf (Double difficulty) {
        setName(new String[]{"Волк", "Волка", "Волку", "Волка", "Волком", "Волке"});
        setFemale(false);
        setMaxHealth((int) (15 * difficulty));
        setCurrentHealth((int) (15 * difficulty));
        setResourceType("Выносливость");
        setMaxResource((int) (15 * difficulty));
        setCurrentResource((int) (15 * difficulty));
        setStrength(5);
        setDexterity(3);
        setMind(1);
        setCharisma(2);
        ...
        setExpReward(3);
        setPortraitUrl("/com/stormtale/stormtale/images/wolf_portrait.png");
        setImageUrl("/com/stormtale/stormtale/images/wolf.png");
    }
    @Override
